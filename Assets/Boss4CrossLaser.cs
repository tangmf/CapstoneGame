...
public class Boss4CrossLaser : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        /*hitbox1 = boss4CrossLaser1.GetComponent<LineRenderer>();
        hitbox2 = boss4CrossLaser2.GetComponent<LineRenderer>();
        hitbox3 = boss4CrossLaser3.GetComponent<LineRenderer>();
        hitbox4 = boss4CrossLaser4.GetComponent<LineRenderer>();*/
    ...
    {
        LaserAttackI(playerPos, currentPos, width, boss4CrossLaser1, lineRenderer1, 0);
        LaserAttackI(playerPos, currentPos, width, boss4CrossLaser2, lineRenderer2, 90);
        LaserAttackI(playerPos, currentPos, width, boss4CrossLaser3, lineRenderer3, 180);
        LaserAttackI(playerPos, currentPos, width, boss4CrossLaser4, lineRenderer4, 270);
    }

    public void LaserAttackI(Vector3 playerPos, Vector3 currentPos, float width, GameObject boss4CrossLaser, LineRenderer lineRenderer, float angle)
    {
        lineRenderer.startWidth = width;
